...
public class TelaLocacaoEquipamentos {
    ...
    public VBox getView() {
     ...
     repository.EquipamentoRepository repoTemp = new repository.EquipamentoRepository();
     cbEquipamento.setItems(FXCollections.observableArrayList(repoTemp.listarTodos()));
     // ---------------------
